Shader "Custom/SS_BlinnPhong"
{
    ...
    SubShader
    {
        ...
        float4 LightingBPhong(SurfaceOutput s,fixed3 lightDir, float3 viewDir, fixed atten)
        {
                ...
                float spec = dot(halfVec, s.Normal);
                spec = pow(max(0, spec), _SpecPower);
